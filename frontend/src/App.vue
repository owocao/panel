...
<template>
  <main class="shell sun-shell" @click="handleShellClick">
    ...
    <template v-else>
      ...
      <section v-if="activeView === 'home'" class="home-panel sun-panel" @selectstart="preventHomeSelection" @dragstart="preventHomeSelection" @keydown.capture="handleHomeKeydown">
